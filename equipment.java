...
//    public static List<Integer> equip() {
...
//     for (int i = 0; i < 4; i++) {
//         System.out.print("Enter the ID of equipment to equip (" + (i + 1) + "/4): ");
...
//             System.out.println("You already equipped that item. Pick a different one.");
//             i--;
//             continue;
//         }
...
//             if (eq.ID == choice) {
//                 System.out.println("Equipped: " + eq.name);
//                 break;
//             }
//         }
//     }
